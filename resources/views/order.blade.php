...
<section class="container mx-auto py-20 px-10 bg-gray-100 max-w-4xl">
    ...
    <table class="border-collaspe border-collapse table-auto w-full">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td class="border px-4 py-2">{{$item['qty'] * $item['item']['price']}}$</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <form method="POST" action="/order/store" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
            ...
            <input
                ...
                name="name" id="name" type="text" value="{{ Auth::user()->name }}">
        </div>
        <div class="mb-6">
            ...
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                name="email" id="email" type="email" value="{{ Auth::user()->email }}">
        </div>
        <hr>
